...
add_arg('use_model',        str,    'c18_net',             '所使用的模型')
...
add_arg('feature_method',   str,    'GABF',         '音频特征提取方法', choices=['melspectrogram', 'spectrogram'])
...
class M5(nn.Module):
    def __init__(self, n_input=47, n_output=8, stride=2, n_channel=47):
        super().__init__()
        ...
        self.conv3 = nn.Conv2d(n_channel, 80, kernel_size=3)
        self.bn3 = nn.BatchNorm2d(80)
        self.conv4 = nn.Conv2d(80, 80, kernel_size=3)
        self.bn4 = nn.BatchNorm2d(80)
        self.pool4 = nn.MaxPool2d(3)
        self.fc1 = nn.Linear(80, n_output)
...
def train(args):
    ...
    test_dataset_keliban = CustomDataset(args.test_list_path+'keliban.txt',
                                 ...
                                 sr=48000,
                                 chunk_duration=3)
    test_loader_keliban = DataLoader(dataset=test_dataset_keliban, batch_size=args.batch_size, num_workers=args.num_workers)
    ...
    test_dataset_miduban = CustomDataset(args.test_list_path+'miduban.txt',
                                 ...
                                 sr=48000,
                                 chunk_duration=3)
    test_loader_miduban = DataLoader(dataset=test_dataset_miduban, batch_size=args.batch_size, num_workers=args.num_workers)
    ...
    test_dataset_duocenban = CustomDataset(args.test_list_path+'duocenban.txt',
                                 ...
                                 sr=48000,
                                 chunk_duration=3)
    test_loader_duocenban = DataLoader(dataset=test_dataset_duocenban, batch_size=args.batch_size, num_workers=args.num_workers)
    ...
    test_dataset_shanmu = CustomDataset(args.test_list_path+'shanmu.txt',
                                 ...
                                 sr=48000,
                                 chunk_duration=3)
    test_loader_shanmu  = DataLoader(dataset=test_dataset_shanmu , batch_size=args.batch_size, num_workers=args.num_workers)
    ...
    test_dataset_songmu = CustomDataset(args.test_list_path+'songmu.txt',
                                 ...
                                 sr=48000,
                                 chunk_duration=3)
    test_loader_songmu = DataLoader(dataset=test_dataset_songmu, batch_size=args.batch_size, num_workers=args.num_workers)
